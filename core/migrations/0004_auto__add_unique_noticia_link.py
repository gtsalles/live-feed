...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Noticia', fields ['link']
        db.create_unique(u'core_noticia', ['link'])


    def backwards(self, orm):
        # Removing unique constraint on 'Noticia', fields ['link']
        db.delete_unique(u'core_noticia', ['link'])
    ...
    models = {
        u'core.noticia': {
            ...
            'link': ('django.db.models.fields.URLField', [], {'unique': 'True', 'max_length': '200', 'db_index': 'True'}),
